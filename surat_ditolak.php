...
<!-- 
    ...
    <a href="export_excel_ditolak.php"><button type="button" class="btn btn-success"><i class="fas fa-file-medical"></i>  Cetak Excel</button></a>
...
<tbody>
    ...
    <tr>
      ...
      $query = mysqli_query($conn,"SELECT * from surat_ditolak") or die (mysqli_error($con));
