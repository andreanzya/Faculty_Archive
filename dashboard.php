              ...
              <?php
                    ...
                    //  }else{
                       ...
                       require_once("include/connection.php");
                             ...
                             $sql ="SELECT *,count(jenis_surat) as count FROM surat_masuk group by jenis_surat;";
                             $result = mysqli_query($conn,$sql);
                             $chart_data="";
                             while ($row = mysqli_fetch_array($result)) { 
                     
                                $name[]  = $row['jenis_surat']  ;
                                $counts[] = $row['count'];
                            }
                    ...
                    ?>
                <CENTER><h3 class="page-header" >Pengajuan Surat Akademik Yang Harus Dikerjakan</h3></CENTER>  
