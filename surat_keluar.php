...
<!-- 
    ...
    <a href="export_excel.php"><button type="button" class="btn btn-success"><i class="fas fa-file-medical"></i>  Cetak Excel</button></a>
    </div>
...
<tbody>
    ...
    <tr>
      ...
      $query = mysqli_query($conn,"SELECT * from surat_keluar") or die (mysqli_error($con));
