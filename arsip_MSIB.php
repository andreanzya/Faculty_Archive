...
<tbody>
    ...
    <tr>
      ...
      $query = mysqli_query($conn,"SELECT * from surat_msib where jenis_surat = 'MSIB'") or die (mysqli_error($con));
      ...
      <td><?php echo $tanggal; ?></td>
           ...
           <td><a href='template_MSIB.php?file_id=<?php echo $num; ?>'  class="btn btn-sm btn-outline-primary"><i class="fa fa-download"></i></a> <a href='delete_msib.php?file_id=<?php echo $num; ?>'  class="btn btn-sm btn-outline-danger"><i class="fa fa-trash"></i></a>
    </tr>
<?php } ?>
</tbody>
   </table>
