...
<div class="">
 ...
 <table id="dtable" class = "table table-striped">
    ...
    <div class="footer-copyright py-3">
      <p>Universitas Esa Unggul All right Reserved <?php echo date('Y');?> &copy;<br> Created By : Tedy Andreansyah</p>
    </div>
    <!--/.Copyright-->
...
?>
  <div class="modal-dialog" role="document">
    ...
    <div class="modal-content">
      <div class="modal-header text-center">
        ...
        <div class="md-form mb-5">
          <i class="fas fa-envelope prefix grey-text"></i>
          <input type="email" id="orangeForm-email" name="admin_email" value="<?php echo $admin1;?>" class="form-control validate">
          <label data-error="wrong" data-success="right" for="orangeForm-email">Your email</label>
        </div>
        ...
        <div class="md-form mb-4">
          ...
          <label for="orangeForm-pass">User Status</label>
        </div>
 ...
 if(isset($_POST['edit2'])){
     ...
     mysqli_query($conn,"UPDATE `admin_login` SET `name` = '$user_name', `admin_email` = '$admin_email', `admin_password` = '$admin_password' where id='$id'") or die (mysqli_error($conn));
