...
<tbody>
    ...
    <tr>
      ...
      $query = mysqli_query($conn,"SELECT * from history_login") or die (mysqli_error($conn));
      while($file=mysqli_fetch_array($query)){
       //  $id =  $file['id'];
         $name =  $file['admin_email'];
         $ip =  $file['ip'];
         $host =  $file['host'];
         $action =  $file['action'];
...
<?php } ?>
    ...
    <div class="footer-copyright py-3">
     <p>All right Reserved <?php echo date('Y');?> &copy; <br><br> Created By : Tedy Andreansyah</p>
    </div>
    <!--/.Copyright-->
