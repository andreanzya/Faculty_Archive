...
<!-- 
    ...
    <a href="#"><button type="button" class="btn btn-success"><i class="fas fa-file-medical"></i>  Surat Keterangan Aktif</button></a>
...
<tbody>
    ...
    <tr>
      ...
      $query = mysqli_query($conn,"SELECT * from surat_skam where jenis_surat = 'SKAM'") or die (mysqli_error($con));
      ...
      <td><?php echo $tanggal; ?></td>
           ...
           <td><a href='template_SKAM.php?file_id=<?php echo $num; ?>'  class="btn btn-sm btn-outline-primary"><i class="fa fa-download"></i></a> <a href='delete_skam.php?file_id=<?php echo $num; ?>'  class="btn btn-sm btn-outline-danger"><i class="fa fa-trash"></i></a>
    </tr>
<?php } ?>
</tbody>
   </table>
