...
require_once("include/connection.php");
    ...
    if(isset($_GET['file_id'])){
        ...
        $query = mysqli_query($conn,"SELECT * from surat_keluar where no_surat = $id and jenis_surat = 'SKAM'") or die (mysqli_error($con));
        while($surat=mysqli_fetch_assoc($query)){
            ...
            $attachment = 'output/keterangan_aktif/'.$num.'_surat_SKAM_'.$nama.'.docx';
