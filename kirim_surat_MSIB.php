...
require_once("include/connection.php");
    ...
    if(isset($_GET['file_id'])){
        ...
        $query = mysqli_query($conn,"SELECT * from surat_keluar where no_surat = $id and jenis_surat = 'MSIB'") or die (mysqli_error($con));
        while($surat=mysqli_fetch_assoc($query)){
            ...
            $attachment = 'output/MSIB/'.$num.'_surat_MSIB_'.$nama.'.docx';
            $attachment1 = 'output/SPTJM/'.$num.'_surat_SPTJM_'.$nama.'.docx';
